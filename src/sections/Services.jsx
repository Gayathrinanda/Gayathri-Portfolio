      ...
      <div className='relative'>
          ...
          <div className="main-container grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 items-start">
            ...
            <div className="flex items-center">
              <p className="text-lg lg:text-xl leading-relaxed">
                  Building modern, user-focused websites with clean layouts,
        ...
        <div className="bg-white text-black py-16 lg:py-20 sticky top-2/3">
          <div className="main-container grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 items-start">
            ...
            <div className="flex items-center">
              <p className="text-lg lg:text-xl leading-relaxed">
                  Content writer who crafts impactful, well-structured writing for a wide range of digital needs. Whether it’s brand messaging, creative copy, or content for creators, that truly strengthens the voice behind it.
              </p>
            </div>
